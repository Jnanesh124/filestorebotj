...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6570037316:AAGO251jw1GYfIAEzqN5qosLgmHfZj6w-C8")
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello {first}, Thanks for using  @ROCKERSBACKUP ⚡️.")
try:
    ADMINS=[]
...
USER_REPLY_TEXT = "https://t.me/movie_requist_j_Bot"
